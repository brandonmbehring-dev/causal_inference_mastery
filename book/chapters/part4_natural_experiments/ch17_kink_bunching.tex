...
\begin{minted}[fontsize=\small, linenos]{python}
from causal_inference.rkd import (
...
# First stage test (for fuzzy RKD)
# fs_result = first_stage_test(D, X, c, bandwidth=0.3)

# Full diagnostics summary
diagnostics = rkd_diagnostics_summary(
    X=X, cutoff=c, bandwidth=0.3, covariates=W.reshape(-1, 1)
)
